...
export const UploadScreen: React.FC = () => {
  ...
  return (
    <div className="h-full overflow-y-auto">
      <div className="min-h-full p-4 sm:p-6 pt-4 sm:pt-8">
              ...
              >
                ...
                {uploadedFile && (
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    className="mt-4 sm:mt-6 glass-effect p-4 sm:p-6 rounded-lg"
                  >
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 space-y-2 sm:space-y-0">
                      <span className="font-medium text-white text-sm sm:text-base truncate pr-4">{uploadedFile.name}</span>
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              >
                <motion.button
                  ...
                  className={`
                    w-full p-4 sm:p-6 lg:p-8 rounded-xl font-semibold text-base sm:text-lg lg:text-xl transition-all duration-300
                    ${canGenerate
