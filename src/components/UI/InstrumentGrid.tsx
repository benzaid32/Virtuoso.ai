...
export const InstrumentGrid: React.FC<InstrumentGridProps> = ({
  ...
  if (mode === 'solo') {
    return (
      <div className="space-y-4">
        <h3 className="text-lg font-semibold text-white">Select Instrument</h3>
        ...
        <div className="grid grid-cols-2 gap-4">
          {INSTRUMENTS.map((instrument) => (
            ...
            >
              ...
              <p className="text-sm text-gray-400 mb-2">{instrument.description}</p>
  ...
  return (
    <div className="space-y-4">
      <h3 className="text-lg font-semibold text-white">Select Ensemble</h3>
        ...
        {ENSEMBLES.map((ensemble) => (
          ...
          >
            <div className="flex items-center space-x-3 mb-3">
              <span className="text-3xl">{ensemble.icon}</span>
              <div>
                <span className="font-semibold text-lg">{ensemble.name}</span>
                <p className="text-sm text-gray-400">{ensemble.description}</p>
              </div>
            </div>
