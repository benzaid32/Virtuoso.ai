        ...
        <div className="text-center">
          {error ? (
            <div className="space-y-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-red-400 mb-2">Upload Error</h3>
                ...
                <button
                  ...
                  className="mt-3 px-4 py-2 bg-red-500/20 text-red-300 rounded-lg hover:bg-red-500/30 transition-colors text-sm"
                >
                  Try Again
                </button>
              </div>
